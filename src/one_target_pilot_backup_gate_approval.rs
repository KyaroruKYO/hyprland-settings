...
pub struct BackupGateApprovalState {
...
pub fn one_target_pilot_backup_gate_approval_state() -> BackupGateApprovalState {
    BackupGateApprovalState {
        approved_gate: "PRODUCTION_BACKUP_CONTRACT_ENABLED",
        previous_value: false,
        new_value: PRODUCTION_BACKUP_CONTRACT_ENABLED,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct BackupGateReadinessChange {
    pub pre_enable_audit_gate_passed: bool,
    pub backup_contract_gate_approved: bool,
    pub backup_contract_allowed_as_prerequisite: bool,
    pub production_backup_creation_reachable: bool,
    pub verification_gate_enabled: bool,
...
pub fn one_target_pilot_backup_gate_readiness_change() -> BackupGateReadinessChange {
    BackupGateReadinessChange {
        pre_enable_audit_gate_passed: PRODUCTION_ONE_TARGET_PRE_ENABLE_AUDIT_PASSED,
        backup_contract_gate_approved: PRODUCTION_BACKUP_CONTRACT_ENABLED,
        backup_contract_allowed_as_prerequisite: PRODUCTION_BACKUP_CONTRACT_ENABLED,
        production_backup_creation_reachable: false,
        verification_gate_enabled: PRODUCTION_VERIFICATION_CONTRACT_ENABLED,
        ...
        writes_enabled: false,
        next_recommended_gate: "PRODUCTION_VERIFICATION_CONTRACT_ENABLED",
    }
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct BackupGateMeaning {
    pub meaning: &'static str,
    pub non_meanings: Vec<&'static str>,
}

pub fn one_target_pilot_backup_gate_meaning() -> BackupGateMeaning {
    BackupGateMeaning {
        meaning:
            "The production backup contract stage is approved as a prerequisite for the future one-target pilot path.",
        non_meanings: vec![
            "writes are enabled",
            "Apply can write",
...
pub fn one_target_pilot_backup_gate_inventory_after() -> Vec<OneTargetPilotGateSnapshotItem> {
    one_target_pilot_gate_inventory_snapshot()
}

pub fn one_target_pilot_backup_gate_single_gate_state_is_preserved() -> bool {
    pre_enable_and_backup_gates_are_true()
