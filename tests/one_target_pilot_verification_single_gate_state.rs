...
use hyprland_settings::one_target_pilot_verification_gate_approval::{
    one_target_pilot_verification_gate_inventory_after,
    one_target_pilot_verification_gate_single_gate_state_is_preserved,
};
...
#[test]
fn pre_enable_backup_and_verification_gates_are_true_and_write_execution_gates_false() {
    let gates = one_target_pilot_verification_gate_inventory_after();
    ...
    assert!(one_target_pilot_verification_gate_single_gate_state_is_preserved());
