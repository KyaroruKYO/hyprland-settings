...
fn high_risk_recovery_reports_keep_all_high_risk_rows_blocked() -> Result<()> {
    ...
    assert_eq!(design["counts"]["rowsEnabled"], 9);
    assert_eq!(design["counts"]["finalWritableRows"], 278);
    assert_eq!(design["counts"]["finalBlockedRows"], 63);
    ...
    assert_eq!(readiness["counts"]["remainingBlockedRows"], 0);
    assert_eq!(readiness["counts"]["finalWritableRows"], 341);
    assert_eq!(readiness["counts"]["finalBlockedRows"], 0);
    assert_eq!(
