...
fn disabled_future_approval_cards_are_visible_and_non_mutating() {
    ...
    for expected in [
        ...
        "hyprland-settings-source-include-production-activation-cap-disabled",
        "hyprland-settings-source-include-production-activation-cap-evidence",
        "hyprland-settings-duplicate-production-activation-cap-disabled",
        "hyprland-settings-duplicate-production-activation-cap-evidence",
