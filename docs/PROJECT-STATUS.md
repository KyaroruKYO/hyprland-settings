...
- Structured-family editors/writes: 68-76%
...
Current next exact work item: add review-only per-record editor forms for structured-family records while keeping real writes blocked.
