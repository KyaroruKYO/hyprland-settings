...
- Structured-family editors/writes: 80-88%
...
Current next exact work item: add fixture-only structured-family draft rendered-record approval/confirmation model while keeping real writes blocked.
