...
- Structured-family editors/writes: 70-78%
...
Current next exact work item: add review-only structured-family record edit-state/draft model while keeping real writes blocked.
