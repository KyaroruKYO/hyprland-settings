...
- Structured-family editors/writes: 78-86%
...
Current next exact work item: add fixture-only structured-family draft rendered-record diff/review summary while keeping real writes blocked.
