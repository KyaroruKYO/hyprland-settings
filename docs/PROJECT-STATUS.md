...
- Structured-family editors/writes: 84-92%
...
Current next exact work item: add fixture-only structured-family rendered-record staged apply dry-run report while keeping real writes blocked.
