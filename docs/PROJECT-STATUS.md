...
Next exact work item: design a persistence boundary for activation drafts without enabling persistence by default, or keep the branch capped until production activation safety gates are ready.
