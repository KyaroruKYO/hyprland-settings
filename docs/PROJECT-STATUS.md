...
- Structured-family editors/writes: 74-82%
...
Current next exact work item: add fixture-only structured-family draft-to-rendered-record planning while keeping real writes blocked.
