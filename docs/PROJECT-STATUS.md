...
Next exact work item: connect live GTK field editing to the memory-only draft-edit model behind still-disabled controls, without persistence, production actions, or executor wiring.
...
The GTK matrix was run for the draft-edit UI at `/tmp/hyprland-settings-gtk-automation/20260620_151212`; screenshot plus AT-SPI accessibility-tree assertions passed for the source/include and duplicate draft-edit cards.
