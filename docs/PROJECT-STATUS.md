...
- Structured-family editors/writes: 82-90%
...
Current next exact work item: add fixture-only structured-family rendered-record staged apply plan while keeping real writes blocked.
