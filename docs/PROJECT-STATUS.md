...
- Structured-family editors/writes: 76-84%
...
Current next exact work item: add fixture-only structured-family draft rendered-record render/reread proof while keeping real writes blocked.
